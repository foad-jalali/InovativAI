...
export default function AiAndDataSolutionPage() {
  ...
  return (
    <>
      ...
      <section id="artificial-intelligence-and-data-science" className="section-padding pt-32">
...
"
      ...
      <section id="machine-learning-models-and-applications" className="section-padding pt-32">
        <div className="container-custom">
          <SectionHeading
      ...
      <section className="section-padding bg-gradient-to-b from-purple-900/20 to-transparent">
        <div className="container-custom">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4" data-aos="fade-up">
            ...
            <Link href="/solutions/software-engineering-and-development" className="btn-secondary">
